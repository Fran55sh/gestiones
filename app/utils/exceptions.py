...
class StorageError(AppError):
    ...
    def __init__(self, message: str = "Error al procesar datos", operation: Optional[str] = None, details: Optional[dict] = None):
...
class ConfigurationError(AppError):
    ...
    def __init__(self, message: str = "Error de configuración", config_key: Optional[str] = None, details: Optional[dict] = None):
        super().__init__(message, status_code=500, details=details)
